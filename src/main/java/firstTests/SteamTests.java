...
public class SteamTests extends BaseDriverPage{
   ...
   public void init(){
    ...
    public void searchTest (){
        ...
        assertTrue("В выборке отсутствует тайтл с название 'Max Payne'", !titles.contains("Max Payne"));
    }

    @Test
    public void checkPage(){

       wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(text(),'Информация')]"))).click();
